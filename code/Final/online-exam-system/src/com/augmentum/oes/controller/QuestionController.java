...
public class QuestionController {
    ...
    public ModelAndView readyToEdit(@RequestParam("questionId") String questionId) {
        ...
        modelAndView.addObject("questionDisplayId", FormatUtil.getModelDisplayId(question.getId()));
    ...
    public ModelAndView find(
        ...
        for (Question question : questionList) {
            question.setDisplayId("Q" + FormatUtil.getModelDisplayId(question.getId()));
        }
