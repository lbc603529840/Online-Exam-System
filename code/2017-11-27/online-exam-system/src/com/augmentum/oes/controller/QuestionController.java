...
public class QuestionController {
    ...
    public ModelAndView create(
        ...
        modelAndView.setView(new RedirectView(AppContext.getContextPath() + "/page/question/find?orderBy=DESC"));
        return modelAndView;
    }
    ...
    public ModelAndView remove(
        ...
        modelAndView.setView(new RedirectView(AppContext.getContextPath() + "/page/question/find"));
        return modelAndView;
    }
